...
<img src=".\Images\Friction_Analysis_Map_No_LC.png" alt="Friction Utilization Map" width="960" height="540">
...
<ul>
	...
	<li>/Utilities folder: Functions used by the code repository.</li>

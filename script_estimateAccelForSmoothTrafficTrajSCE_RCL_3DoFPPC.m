...
addpath('./Datafiles/Realistic Trajectories Test Cases/'); % all .mat files
addpath('./Utilities')
        ...
        if isempty(RT_veh_cg_east) == 0
            ...
            for index_vehicle = 1:N_vehicles
                ...
                if RT_veh_path_min_length > 1
                    ...
                    % DO NOT SIMULATE if there was a lane change
                    ...
                    if isempty(isLanechange) == 0
                        ...
                        % check that you have enough data to simulate
                        if RT_veh_min_station_length >= 5
                            ...
                            min_trip_size = 1;
                            %% Process a vehicle trajectory between the first start and stop
                            for index_stop = 1
                                    ...
                                    if isempty(total_time_check) == 1
                                        ...
                                        if VT_veh_min_station_length >= 5
                                            ...
                                            if flag.plot
                                                ...
                                                fcn_VD_plotStationFrictionDemand(cg_station_RCL,friction_demand_fl,08);
                        ...
                        end % NOTE: END IF statement for minimum length of reference trajectory
                    end % NOTE: END IF statement to check if a lane change occurs
            ...
            if vehicle_counter > 0
                ...
                % Actual number of vehicles simulated
            ...
            end % NOTE: END IF statement to store data if > 0 vehicles were simulated

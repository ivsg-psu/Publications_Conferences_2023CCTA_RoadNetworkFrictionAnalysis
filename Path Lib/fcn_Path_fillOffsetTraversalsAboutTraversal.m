...
if flag_do_plots
    ...
    title('Reference Traversal, Offset Traversal(s), and Raw Trajectories', 'Interpreter', 'latex', 'Fontsize', 13);
    ...
    % Add a legend
%     legend('Road Centerline', 'Lane Centerline','Lane Centerline','Raw Trajectory','location','best');
end
